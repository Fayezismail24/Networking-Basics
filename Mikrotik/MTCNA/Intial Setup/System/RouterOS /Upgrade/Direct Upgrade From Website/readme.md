Here's the upgrade process in **Markdown (MD)** format:
...
* **Firmware Upgrade (Optional):** If you're also updating the firmware, follow the instructions specific to your device model on the **MikroTik support page**.
...
This will generate a structured Markdown document detailing the steps for upgrading MikroTik RouterOS from the MikroTik website. Let me know if you need any adjustments!
```

<img width="1909" height="964" alt="image" src="https://github.com/user-attachments/assets/aac3aa98-32cd-4364-97ed-dd9f0a3c18b6" />
