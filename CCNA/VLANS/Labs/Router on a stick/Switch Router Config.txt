...
SW(config-vlan)#do wr
SW(config-vlan)#exit 
---

###**Verify VLANs:**

SW#show vlan brief // To see if the VLANS  Created Succesfully 
...
1.3 Configure Trunk Port to Router
...
###**2.3 Configure Subinterfaces for VLANs:**
